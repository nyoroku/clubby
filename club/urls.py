...
urlpatterns = [
    ...
    path('club/request-otp/', views.request_otp),  # Legacy fallback
    ...
    path('service-worker.js', TemplateView.as_view(template_name='service_worker.js', content_type='application/javascript'), name='service_worker'),
]
